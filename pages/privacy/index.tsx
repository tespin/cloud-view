        ...
        <Container className='xs:flex-col xs:justify-center xs:items-center xs:w-96 xs:max-w-sm xs:my-4 xs:mx-8'>
          ...
          <main>
            ...
            <div className='xs:flex xs:flex-col xs:space-y-4 xs:mt-4 xs:text-base-md'>
              <p>
                Location data is used when initially requesting images but is
                not kept or stored afterwards.
              </p>
              <p>
                This project will not add you to any list or sell / share your
                information.
              </p>
            </div>
          </main>
